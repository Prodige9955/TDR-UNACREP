                        ...
                        <tr>
                            ...
                            <td>
                                <div class="bloc-buttons">
                                    <div class="haut-buttons">
                                        <a href="modifier_tdr.php?id=<?php echo $tdr['idtdr']; ?>" class="btn btn-sm btn-warning">Modifier</a>
                                        <a href="supprimer_tdr.php?id=<?php echo $tdr['idtdr']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Confirmer la suppression ?');">Supprimer</a> <br>
                                    </div>
                                    <div class="bas-buttons">
                                        <a href="detail_tdr.php?id=<?php echo $tdr['idtdr']; ?>" class="bouton-detail">Voir détails</a><br><br> 
                                    </div>
                                </div>             
                            </td>
                        </tr>
